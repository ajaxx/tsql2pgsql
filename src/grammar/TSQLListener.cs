...
public interface ITSQLListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterRollbackTransaction([NotNull] TSQLParser.RollbackTransactionContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="TSQLParser.rollbackTransaction"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitRollbackTransaction([NotNull] TSQLParser.RollbackTransactionContext context);
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterCommitTransaction([NotNull] TSQLParser.CommitTransactionContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="TSQLParser.commitTransaction"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitCommitTransaction([NotNull] TSQLParser.CommitTransactionContext context);
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterExistsExpression([NotNull] TSQLParser.ExistsExpressionContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="TSQLParser.existsExpression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitExistsExpression([NotNull] TSQLParser.ExistsExpressionContext context);
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterPrintExpression([NotNull] TSQLParser.PrintExpressionContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="TSQLParser.printExpression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitPrintExpression([NotNull] TSQLParser.PrintExpressionContext context);
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterSetSessionParameter([NotNull] TSQLParser.SetSessionParameterContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="TSQLParser.setSessionParameter"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitSetSessionParameter([NotNull] TSQLParser.SetSessionParameterContext context);
